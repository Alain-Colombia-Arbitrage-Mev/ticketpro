...
/**
 * Vite Configuration - Optimizado para Bun
 * 
...
export default defineConfig({
    ...
    build: {
      ...
      sourcemap: false, // Cambiar a true en desarrollo si necesitas debugging
      ...
      rollupOptions: {
        ...
        // Performance: Preferir ESM para mejor tree-shaking
        preserveEntrySignatures: 'strict',
      },
      // Chunk size warnings (ajustar según necesidades)
    ...
    // Pre-bundling optimizado para Bun
    optimizeDeps: {
      ...
      exclude: [],
      // Configurar para manejar CommonJS modules
      esbuildOptions: {
        define: {
          global: 'globalThis',
        },
